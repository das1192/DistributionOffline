<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Vendor_OutgoingForm.aspx.cs" Inherits="TalukderPOS.Web.UI.Vendor_OutgoingForm"
    Title="Supplier Payment" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:TabContainer ID="ContainerProductVendor" runat="server" ActiveTabIndex="0" Width="100%"
                ...
                <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Pay Supplier">
                    <ContentTemplate>
                        <div class="row">
...
<%--                                                <asp:CascadingDropDown ID="CCD8" runat="server" Category="Vendor" TargetControlID="ddlVendorList"
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label11" runat="server" Text="Payment From"></asp:Label>
                                        </td>
                                        <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <asp:CascadingDropDown ID="CascadingDropDown78" runat="server" Category="Vendor"
                                            TargetControlID="ddlVendorListnew" LoadingText="Loading Supplier..." PromptText="--Please Select--"
                            ...
                            <tr>
                                <td colspan="5">
                                    <table width="100%">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvVendorAmount" runat="server" AutoGenerateColumns="False" GridLines="None"
                                                    CssClass="mGrid" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    DataKeyNames="ReferenceNo,OID" EmptyDataText="No rows returned" OnRowDeleting="gvVendorAmount_RowDeleting"
                                                    OnRowEditing="gvVendorAmount_RowEditing" Width="100%">
                                                    <AlternatingRowStyle CssClass="alt" />
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <HeaderTemplate>
                                                        ...
                                                        <asp:BoundField DataField="Vendor_Name" HeaderText="Supplier">
                                                            <HeaderStyle HorizontalAlign="Center" />
                ...
                <asp:TabPanel ID="TabPanel4" runat="server" HeaderText="Supplier Due Report" Visible="false">
                    <ContentTemplate>
                        <table width="100%">
                            <tr>
                                <td align="left">
                                ...
                                <td>
                                    <div>
                                        ...
                                        <asp:CascadingDropDown ID="Cascadingdropdown1" runat="server" Category="Vendor" TargetControlID="ddlVendorID"
                                            LoadingText="Loading Categories..." PromptText="--Please Select--" ServiceMethod="BindVendor"
                                            ServicePath="~/DropdownWebService.asmx" Enabled="True">
                                        </asp:CascadingDropDown>
                                    </div>
                                </td>
                                ...
                                <td colspan="2">
                                    <asp:GridView ID="gvVendorDue" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total Purchase Amendment">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblPayment" runat="server" Text='<%#Bind("sumamendment") %>'></asp:Label></ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                ...
                <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="Supplier Transaction">
                    <HeaderTemplate>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="gvSupplierTransaction" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    CellPadding="3" EmptyDataText="No rows returned" OnRowDeleting="gvVendorAmount_RowDeleting"
                                                    OnRowEditing="gvVendorAmount_RowEditing" Width="100%">
                                                    <AlternatingRowStyle CssClass="alt" />
                                                    <Columns>
