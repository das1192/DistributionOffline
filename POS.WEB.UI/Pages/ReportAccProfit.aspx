<%@ Page Title="Ledger Report" Language="C#" MasterPageFile="~/MasterPage.master"
    AutoEventWireup="true" CodeFile="ReportAccProfit.aspx.cs" Inherits="Pages_ReportAccProfit" %>
    ...
    <div id="main-content">
        <div class="wrapper">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div class="table-responsive bg-success" style="background-color: #debc94;padding:10px 50px;border: 3px solid #93718b;">
                        <div class="bg-dark" style="padding: 5px; font-style: ">
                            <h2 class="text-center text-white" style="background-color:#B8860B;color:#fff;padding:3px;font-weight:bold;">
                                PROFIT/LOSS</h2>
                        </div>
                        ...
                        <div class="row" style="padding:0 50px;">
                            ...
                            <asp:Label ID="lblFromTo" CssClass="text-center" Width="100%" runat="server" Font-Bold="True" Font-Size="Large" style="background-color:#B8860B;color:#fff;width:50%;"></asp:Label>
                            </div>
                            <div class="col-md-6">
                                <asp:Label ID="Label1" runat="server" Text="Opening Stock" CssClass="pull-left" Font-Bold="True"></asp:Label>
                                ...
                                <br />
                                <asp:Label ID="Label5" runat="server" Text="Direct Expense" CssClass="pull-left" Font-Bold="True"></asp:Label>
                                <asp:Label ID="lblDirectExpense" runat="server" Text="" CssClass="pull-right" Font-Bold="True"></asp:Label>
                                
                            </div>
                            <div class="col-md-6">
                            <asp:Label ID="Label4" runat="server" Text="" CssClass="pull-left" Font-Bold="True"></asp:Label>
                            <br />
                                ...
                                <asp:Label ID="lblNetSale" runat="server" Text="" CssClass="pull-right" Font-Bold="True"></asp:Label>
                                 ...
                                 <br />
                                  <asp:Label ID="Label8" runat="server" Text="Commission" CssClass="pull-left" Font-Bold="True"></asp:Label>
                                <asp:Label ID="lblCommission" runat="server" Text="" CssClass="pull-right" Font-Bold="True"></asp:Label>
                                
                                 <br />
                                <asp:Label ID="lblIncomel" runat="server" Text="Income" CssClass="pull-left" Font-Bold="True"></asp:Label>
                                <asp:Label ID="lblIncome" runat="server" CssClass="pull-right" 
