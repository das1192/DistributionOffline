<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="SaleItemsReportForAdmin.aspx.cs" Inherits="Pages_SaleItemsReportForAdmin"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <asp:TabContainer ID="ContainerSalesItems" runat="server" ActiveTabIndex="0" Width="100%">
                <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="Sales Items">
                    <ContentTemplate>
                        <table width="100%">
                            <tr>
                                <td align="left">
                            ...
                            <tr>
                               <td colspan="6" align="right">
                                    <asp:Label ID="lblTotalSalesAmount" runat="server" ForeColor="Green" Font-Bold="True" ></asp:Label>
                                    &nbsp; - &nbsp;
                                    <asp:Label ID="lblTotalDiscount" runat="server" ForeColor="Green" Font-Bold="True" ></asp:Label>
                                    &nbsp; = &nbsp;
                                    <asp:Label ID="lblTotalNetAmount" runat="server" ForeColor="Green" Font-Bold="True" ></asp:Label>
                               </td>
                            </tr>
                            <tr>
                                <td colspan="6">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" GridLines="None"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="SaleQty" HeaderText="Qty">
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:BoundField>
