<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="T_SALES_DTLForm.aspx.cs" Inherits="TalukderPOS.Web.UI.T_SALES_DTLForm"
                        ...
                        <div class="row">
                            <div class="panel2 panel-primary">
                                <table width="100%" class="table-responsive" style="margin-bottom: 25px;">
                                    <tr>
                                        <td align="center" style="font-weight: bold" colspan="3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <%--<asp:Label ID="Label33" runat="server" CssClass="control-label">Sales Date</asp:Label>--%>
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <tr>
                                        <td align="left">
                                            &nbsp;<asp:Label ID="lblCustomerName" runat="server" Text="Customer Name" CssClass=""></asp:Label>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtMobileNumber"
                                                ErrorMessage="Customer Mobile No is required" Display="Dynamic" runat="server" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
                                    ...
                                    <tr id="trBank" runat="server">
                                        ...
                                        <td align="left" colspan="1">
                                            <asp:DropDownList ID="ddlBank" runat="server" CssClass="form-control" AutoPostBack="true">
                                                <asp:ListItem></asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="left">
                                            <asp:Label ID="lblBarcode" runat="server" Text="EMI/Barcode"></asp:Label>
                                            <asp:TextBox ID="txtBarcode" runat="server" CssClass="form-control" placeholder="--Please Select--"
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div style="float: right; width: 30%;">
                                        ...
                                        <%-- <asp:DropDownList ID="ddlSearchDescription" runat="server" CssClass="form-control"
                                            AutoPostBack="True" OnSelectedIndexChanged="ddldescription_SelectedIndexChanged">
                                        </asp:DropDownList>
                                        <asp:CascadingDropDown ID="CDD4" runat="server" Category="Description" TargetControlID="ddlSearchDescription"
                                            ParentControlID="ddlSearchSubCategory" LoadingText="Loading Color..." PromptText="--Please Select Description--"
                                            ServiceMethod="BindDescription" ServicePath="~/DropdownWebService.asmx" Enabled="True">
                                        </asp:CascadingDropDown>--%>
                                        <%--sadiq--%>
                                        <%--<asp:AutoCompleteExtender ID="ACE_Description" runat="server"
                                                 Enabled="True"
                                                MinimumPrefixLength="0" ServiceMethod="GetDescription" ServicePath="~/DropdownWebService.asmx"
                                                TargetControlID="txtDescription" UseContextKey="True" CompletionInterval="50"
                                                CompletionSetCount="40" CompletionListElementID="listPlacement"
                                                EnableCaching="False">
                                            </asp:AutoCompleteExtender>--%>
                                    </div>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Description/Color">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:CheckBox ID="chkGift" runat="server" Text="Gift" AutoPostBack="True" OnCheckedChanged="chkGift_CheckedChanged"
                                                        BackColor="Yellow" Font-Italic="True" ForeColor="#FF0066" />
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="grid_header" />
                                                <ItemStyle CssClass="alphabetic" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="MRP">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:TextBox ID="txtSalePrice" runat="server" Width="40px" Text='<%#Bind("SalePrice") %>'
                                                        AutoPostBack="true" onkeypress="return isNumberKey(event)" OnTextChanged="txtSalePrice_TextChanged"></asp:TextBox>
                                                </ItemTemplate>
                                                <HeaderStyle CssClass="grid_header" />
                                                <ItemStyle CssClass="alphabetic" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Delete">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="false" Text="Delete"
                                                        OnClick="lnkDelete_Click"> <img alt="Delete" src="../Images/Delete.gif" /></asp:LinkButton>
                                                </ItemTemplate>
                                        ...
                                        <td style="font-size: large; font-weight: normal; color: #000080">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="width: 30%">
                                                        <asp:TextBox ID="txtGift" runat="server" CssClass="form-control" Width="100px" Font-Bold="True"
                                                            Style="text-align: right;" Text="0" Font-Size="Small" Enabled="false"></asp:TextBox>
                                                    </td>
                                                    <td align="left" style="width: 30%">
                                                        Tk.
                                                    </td>
                                                ...
                                                <tr id="trCashPaid" runat="server">
                                                    ...
                                                    <td align="center" style="width: 30%">
                                                        <asp:TextBox ID="lblcashpaid" runat="server" CssClass="form-control" Width="100px"
                                                            ...
                                                            Font-Size="Small" AutoPostBack="True" OnTextChanged="lblcashpaid_TextChanged"></asp:TextBox>
                                                    </td>
                                                    <td align="left" style="width: 30%">
                                                        Tk.
                                                    </td>
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Button ID="btnCheckChanges" runat="server" Text="Button" OnClick="btnCheckChanges_Click"
                                                            Visible="False" />
                                                    </td>
                                                </tr>
                                                <tr>
