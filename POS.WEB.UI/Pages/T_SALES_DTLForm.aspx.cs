...
", ddlSearchProductCategory.SelectedValue.ToString());
        ...
        {
            sql = "select OID,PaymentMode as Name from PaymentMode pm where pm.OID not in (16,15,17)";
...
", ShopID);
        ...
        //    string newBarcode = dt.Rows[0]["Barcode"].ToString();
        //    string newDescriptionID = dt.Rows[0]["DescriptionID"].ToString();
        ...
        //            string existedDescriptionID = ((Label)gvT_SALES_DTL.Rows[i].FindControl("lblDescriptionID")).Text;
        ...
        //                objAddedItemDetails.SalePrice = Convert.ToDecimal(((TextBox)gvT_SALES_DTL.Rows[i].FindControl("txtSalePrice")).Text);
        ...
        //            else
        //            {
        //                //item already exist  and barcode empty
        //                if (newDescriptionID == existedDescriptionID)
        //                {
        ...
        //    #region qty disable
        //    //txtBarcode  txt Qty  will be disabled
        //    for (int i = 0; i < gvT_SALES_DTL.Rows.Count; i++)
        //    {
        //        if (!string.IsNullOrEmpty(((TextBox)gvT_SALES_DTL.Rows[i].FindControl("lblbarcode")).Text))
        //        {
        //            ((TextBox)gvT_SALES_DTL.Rows[i].Cells[10].FindControl("Qty")).Enabled = false;
        //            ((TextBox)gvT_SALES_DTL.Rows[i].Cells[11].FindControl("lblbarcode")).Enabled = false;
        //        }
        //        else
        //        {
        //            ((TextBox)gvT_SALES_DTL.Rows[i].Cells[10].FindControl("Qty")).Enabled = true;
        //            ((TextBox)gvT_SALES_DTL.Rows[i].Cells[11].FindControl("lblbarcode")).Enabled = true;
        //        }
        //    }
        //    //
        ...
        protected void txtdiscount_TextChanged(object sender, EventArgs e)
        {
            ...
            //    txtdiscount.Text = "0";
            //}
            //txtNetAmount.Text = BILL.GetNetAmount(txtSubTotal.Text, txtdiscount.Text).ToString();
            //txtReceiveAmount_TextChanged(sender, e);

            LoadNetAmount();
            //if (ddlPaymentMode.SelectedItem.Text == "Cash & Card")
            //{
            //    lblcashpaid_TextChanged(null, null);
            //}
        }

        //protected void txtGift_TextChanged(object sender, EventArgs e)
        //{
        ...
        protected void ddlPaymentMode_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (ddlPaymentMode.SelectedItem.Text == "bKash")
            {
                lblcashpaid.Enabled = false;
                trCardPaid.Visible = false;
                ReceiveAmount.Visible = true;
            ...
            else if (ddlPaymentMode.SelectedItem.Text == "HQ")
            {
            ...
            else if (ddlPaymentMode.SelectedItem.Text == "EMI")
            {
                ...
                else
                {
                    ...
                    if (Session["StoreID"] != null & Session["StuffID"] != null)
                    {
                        ...
                        if (strValidQuantity == "yes")
                        {
                            ...
                            entity.CustomerName = txtCustomerName.Text.ToString();
...
", entity.StoreID,userID,"Sale",lblOID.Value,SalesDateTime);
                            DAL.SaveDataCRUD(sqlLoginfo);
                                    ...
                                    // Commented By Yeasin 15-May-2019
                                    //entityDTL.CategoryID = gvT_SALES_DTL.DataKeys[i].Values["PROD_WGPG"].ToString(); //((Label)gvT_SALES_DTL.Rows[i].FindControl("lblPROD_WGPG")).Text;
                                    ...
                                    entityDTL.DiscountReferenceOID = "0";
                                    entityDTL.CustomerName = entity.CustomerName;

                                    //BILL.T_SALES_DTL_Add(entityDTL);

                                    //update acc_stock
                                    // Sales Details Block Commented By Yeasin 15-May-2019
                                    #region SalesDetails Block
                                    ...
                                    //                                        entityDTL.LedgerAccCusName = txtCustomerName.Text.ToString();
                                    ...
                                    //", SalesDateTime, gvT_SALES_DTL.DataKeys[i].Values["Barcode"].ToString(), gvT_SALES_DTL.DataKeys[i].Values["StoreID"].ToString()
                                    //);
                                    //                                        SaveDataCRUD(cmdStr);
                                    //                                    } 
                                    #endregion
                                ...
                                //                                    entity.LedgerAccCusName = txtCustomerName.Text.ToString();
                                //                                    entity.Narration = "Cash Received from Customer";
                                //                                    BILL.T_SALES_Acc_Journal(entity);
                                //                                }
                                //                                if (ddlPaymentMode.SelectedItem.Text == "Card")
                                //                                {
                                //                                    entity.LedgerAccID = ddlBank.SelectedValue.ToString();
                                //                                    entity.LedgerAccParticular = "Bank";
                                //                                    entity.LedgerAccRemarks = "Bank(Card)";
                                //                                    entity.LedgerAccCusName = txtCustomerName.Text.ToString();
                                //                                    entity.Narration = "Received through Card from Customer";

                                //                                    BILL.T_SALES_Acc_Journalforcard(entity);
                                //                                }
                                //                                if (ddlPaymentMode.SelectedItem.Text == "Cash & Card")
                                //                                {
                                //                                    entity.LedgerAccID = "1";
                                ...
                                //                                    entity.LedgerAccParticular = "Bank";
                                //                                    entity.LedgerAccRemarks = "Bank(Card)";
                                //                                    int abc = Convert.ToInt32(entity.NetAmount) - Convert.ToInt32(entity.ReceiveAmount);
                                //                                    entity.LedgerAccCardPaid = txtCardPaid.Text;// abc.ToString();
                                //                                    entity.Narration = "Received through Card from Customer";
                                //                                    BILL.T_SALES_Acc_Journal2(entity);

                                //                                }
                                //                                if (ddlPaymentMode.SelectedItem.Text == "EMI")
                                //                                {
                                //                                    entity.LedgerAccID = ddlBank.SelectedValue.ToString();
                                //                                    entity.LedgerAccParticular = "Bank";
                                //                                    entity.LedgerAccRemarks = "Bank(EMI)";
                                //                                    entity.LedgerAccCusName = txtCustomerName.Text.ToString();
                                //                                    entity.Narration = "Received through Bank EMI from Customer";

                                //                                    BILL.T_SALES_Acc_Journalforcard(entity);
                                //                                }
                                //                                if (ddlPaymentMode.SelectedItem.Text == "bKash")
                                //                                {
                                //                                    entity.LedgerAccID = "4444";
                                //                                    entity.LedgerAccParticular = "bKash";
                                //                                    entity.LedgerAccRemarks = "bKash";
                                //                                    entity.LedgerAccCusName = txtCustomerName.Text.ToString();
                                //                                    entity.Narration = "Received through bKash from Customer";

                                //                                    BILL.T_SALES_Acc_Journal(entity);
                                //                                }
                                //                                if (ddlPaymentMode.SelectedItem.Text == "On Credit")
                                //                                {
                                //                                    entity.LedgerAccID = "9999";
                                //                                    entity.LedgerAccParticular = "A/R";
                                //                                    entity.LedgerAccCusName = txtCustomerName.Text.ToString();
                                //                                    entity.LedgerAccRemarks = "Customer";
                                //                                    entity.Narration = "Sales on Credit";

                                //                                    BILL.T_SALES_Acc_Journal4(entity);
                                //                                }
...
", Session["StoreID"], barcode);
        ...
        private void LoadNetAmount()
        {
            ...
            txtReceiveAmount.Text = totalNetAmount.ToString("0");
            ...
            else
            {
                ...
                txtCardPaid.Text = (Convert.ToDecimal(txtReceiveAmount.Text) - cashPaid).ToString("0");
            }
