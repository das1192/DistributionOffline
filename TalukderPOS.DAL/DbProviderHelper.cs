    ...
    public class DbProviderHelper
    {
        ...
        public static DbConnection GetConnection()
        {
            if (dbConnection == null)
            {
                ...
                dbProviderFactory = DbProviderFactories.GetFactory(connectionStringsSection.ConnectionStrings["conn_str"].ProviderName);
                dbConnection = dbProviderFactory.CreateConnection();
                dbConnection.ConnectionString = connectionStringsSection.ConnectionStrings["conn_str"].ConnectionString;
            }
            return dbConnection;
        }
